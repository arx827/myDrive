...
import { Configuration, AuthApiFactory, AuthApi, DepartmentApi, DepartmentApiFactory, ProductApi, ProductSpecApi, ProductApiFactory, ProductSpecApiFactory, AccountApi, AccountApiFactory, RoleApi, RoleApiFactory, MenuApi, MenuApiFactory } from '@fubonlife/<%= code %>-api-axios-sdk'
