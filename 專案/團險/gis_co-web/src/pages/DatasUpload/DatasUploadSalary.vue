<template>
  <div>
    ...
    <DatasUpload
      :tab-value="3"
      :upload-tip="'提醒：一次上傳筆數最多1,000筆。檔案名稱請使用英文、數字編排，以避免上傳出現亂碼。'"
      :upload-msg="'支持上傳格式：僅支援「職保三合一變更」、「富邦人壽團保」格式'"
    />
  </div>
</template>
...
import DatasUpload from '@/pages/DatasUpload/DatasUpload.vue';
import {
	FblColumnType,
	FblPDataGridHolder,
...
@Component({
	components: {
		Breadcrumb, FblDataGrid, DataUploadTab, DatasUpload,
	},
})
export default class DataUploadSalary extends Vue {
  @Prop()
  breadcrumb: {}
