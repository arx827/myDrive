...
import AnnouncementSettingDataInfo from '@/pages/AnnouncementSetting/AnnouncementSettingDataInfo.vue';

@Component({
  components: {
    AnnouncementSettingDataInfo,
  },
})
export default class AnnouncementSetting extends Vue {
  /**
   * data
   */
