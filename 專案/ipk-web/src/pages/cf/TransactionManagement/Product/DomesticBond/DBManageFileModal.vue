              ...
              >
                <a-row :gutter="[12]" type="flex" align="bottom" :wrap="true">
                  <a-col :span="6">
                    ...
                    >
                      <a-date-picker
                        v-model="addManageFileForm.tradeDate"
                        format="YYYY/MM/DD"
                        placeholder="請輸入"
                        style="width: 100%"
                      />
                  ...
                  <a-col :span="6">
                    ...
                    >
                      ...
                      >
                        <a-select-option
                          v-for="(item, index) in invCategoryCodeOption"
                          :key="index"
                          :value="item.value"
                        >
                          {{ item.label }}
                  ...
                  <a-col :span="6">
                    ...
                    >
                      <a-select
                        v-model="addManageFileForm.asType"
                        placeholder="請選擇"
                        show-search
                        allowClear
                        style="width: 100%"
                      >
                        <a-select-option
                          v-for="(item, index) in asTypeOption"
                          :key="index"
                          :value="item.value"
                        >
                          {{ item.label }}
                  ...
                  <a-col :span="6">
                    ...
                    >
                      <a-select
                        v-model="addManageFileForm.attachmentStatus"
                        placeholder="請選擇"
                        show-search
                        allowClear
                        style="width: 100%"
                      >
                        <a-select-option
                          v-for="(item, index) in attachmentStatusOption"
                          :key="index"
                          :value="item.value"
                        >
                          {{ item.label }}
                ...
                <a-row :gutter="[12]" type="flex" justify="center" align="bottom" :wrap="true">
                  <a-col :span="24" class="text-end mb-3">
                    <IpkButton
                      buttonType="primary"
                      buttonText="查詢"
                      iconType="search"
              ...
              >
                <a-row :gutter="[12]" type="flex" align="bottom" :wrap="true">
                  <a-col :span="6">
                    ...
                    >
                      <a-date-picker
                        v-model="deleteManageFileForm.tradeDate"
                        format="YYYY/MM/DD"
                        placeholder="請輸入"
                        style="width: 100%"
                      />
                  ...
                  <a-col :span="6">
                    ...
                    >
                      <a-select
                        v-model="deleteManageFileForm.asType"
                        placeholder="請選擇"
                        show-search
                        allowClear
                      >
                  ...
                  <a-col :span="6">
                    ...
                    >
                      <a-select
                        v-model="deleteManageFileForm.attachmentStatus"
                        placeholder="請選擇"
                        show-search
                        allowClear
                        style="width: 100%"
                  ...
                  <a-col :span="6">
                    ...
                    >
                      <a-select
                        v-model="deleteManageFileForm.attachmentType"
                        placeholder="請選擇"
                        show-search
                        allowClear
                        style="width: 100%"
                      >
                        <a-select-option
                          v-for="(item, index) in attachmentTypeOption"
                          :key="index"
                          :value="item.value"
                        >
                          {{ item.label }}
...
<script src="./DBManageFileModal.ts" lang="ts">
</script>
