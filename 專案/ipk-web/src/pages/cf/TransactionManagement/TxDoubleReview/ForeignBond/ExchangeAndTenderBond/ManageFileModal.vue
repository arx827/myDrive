              ...
              >
                <a-row :gutter="[12]" type="flex" justify="start" align="bottom" :wrap="true">
                  ...
                  <a-col :span="6">
                    ...
                    >
                      <a-select
                        v-model="addManageFileForm.event"
                        placeholder="請選擇"
                        show-search
                      >
                        <a-select-option
                          v-for="(item, index) in selectorOption.event"
                          :key="index"
                          :value="item.value"
                        >
                          {{ item.label }}
                  ...
                  <a-col :span="6">
                    ...
                    >
                      <a-select
                        v-model="addManageFileForm.currency"
                        placeholder="請選擇"
                        mode="multiple"
                        :filterOption="true"
                        :maxTagCount="2"
                      ...
                      >
                        <a-select-option
                          v-for="(item, index) in selectorOption.currency"
                          :key="index"
                          :value="item.value"
                        >
                          {{ item.label }}
                  ...
                  <a-col :span="6" :push="6" class="text-end mb-3">
                    <IpkButton
                      buttonType="primary"
                      buttonText="查詢"
                      iconType="search"
                      :childrenTab="$cfChildrenTab.childrenTab.EXCHANGE_TENDER_OFFER_TAB.val"
              ...
              >
                <a-row :gutter="[12]" type="flex" justify="start" align="bottom" :wrap="true">
                  ...
                  <a-col :span="6">
                    ...
                    >
                      <a-select
                        v-model="deleteManageFileForm.event"
                        placeholder="請選擇"
                        show-search
                      >
                        <a-select-option
                  ...
                  <a-col :span="6">
                    ...
                    >
                      <a-select
                        v-model="deleteManageFileForm.currency"
                        placeholder="請選擇"
                        mode="multiple"
                        :filterOption="true"
                        :maxTagCount="2"
