              ...
              >
                <a-row :gutter="[12]" type="flex" justify="center" align="bottom" :wrap="true">
                  <a-col :span="6">
                    ...
                    >
                      <a-select
                        v-model="addManageFileForm.isAsia"
                        placeholder="請輸入"
                        show-search
                        :filter-option="filterOption"
                      >
                        <a-select-option
                          v-for="(item, index) in isAsiaOption"
                          :key="index"
                          :value="item.value"
                        >
                          {{ item.label }}
                  ...
                  <a-col :span="6">
                    ...
                    >
                      <a-select
                        v-model="addManageFileForm.hid"
                        placeholder="請輸入"
                        show-search
                        :filter-option="filterOption"
                      >
                        <a-select-option
                          v-for="(item, index) in hierarchyDescOption"
                          :key="index"
                          :value="item.value"
                        >
                          {{ item.label }}
              ...
              >
                <a-row :gutter="[12]" type="flex" justify="center" align="bottom" :wrap="true">
                  <a-col :span="6">
                    ...
                    >
                      <a-select
                        v-model="deleteManageFileForm.isAsia"
                        placeholder="請輸入"
                        show-search
                        :filter-option="filterOption"
                      >
                        <a-select-option
                          v-for="(item, index1) in isAsiaOption"
                          :key="index1"
                          :value="item.value"
                        >
                          {{ item.label }}
                  ...
                  <a-col :span="6">
                    ...
                    >
                      <a-select
                        v-model="deleteManageFileForm.hid"
                        placeholder="請輸入"
                        show-search
                        :filter-option="filterOption"
                      >
