            ...
            <div class="m-3" :style="{ height: '500px', overflow: 'hidden', overflowY: 'scroll'}">
              <div v-if="activeKey === $authService.attachmentTab.key">
                ...
                <div v-if="!isUploadShow">
                  ...
                  >
                    <a-icon type="paper-clip" class="download__icon" />
                    <span class="download" @click="handleDownloadAttachment(item)">
                      {{ item.attachmentName }}
                    </span>
                    <a-icon
                      v-if="!item.isRemoved"
      ...
      <template slot="footer">
        <div class="btnGroup tabline">
          ...
          <IpkButton
            ...
            :childrenTab="childrenTab"
            :buttonKey="$cfButtonKey.buttonKey.MODIFY.val"
            @handleBtnEmit="handleSaveAttachment"
          />
        </div>
      </template>
    </a-modal>
...
<script src="./ForeignCheckInfoModal.ts" lang="ts" />
