...
export default class TxReviewForeignEquity extends Vue {
  ...
  */
  ...
  searchTxReview(dto: TxReviewInfo) {
    ...
    this.$txReview.searchTxReviewInfoUsingPOST(dto)
    .then((res) => {
  ...
  searchTxReviewDetail(txCode: string) {
    this.setLoading(true);
    this.$txReview.searchTxReviewDetailUsingPOST({ txCode })
    .then((res) => {
      const content = res.data.content;
  ...
  validateBeforeModifyCfStatus(dto) {
    ...
    return new Promise((resolve, reject) => {
      this.$txReview.checkBeforeModifyCfStatusUsingPOST(dto)
      .then((res) => {
        resolve(res.data);
      })
      .catch((error) => {
  ...
  modifyCfStatus(dto) {
    this.setLoading(true);
    this.$txReview.modifyCfStatusUsingPATCH(dto)
    .then((res) => {
