      ...
      <div class="modal__body">
        ...
        <div class="modal__btn__wrap btnGroup">
          ...
          <IpkButton
            ...
            :isAuthorize="false"
            @handleBtnEmit="submitAddCashInfo"
          />
        </div>
      </div>
    </div>
...
<script src="./DataCashAddModal.ts" lang="ts" />
