...
import FubonSsiDataInfo from '@/pages/cf/FubonSsi/FubonSsiDataInfo.vue';
import FubonSsiPendingInfo from '@/pages/cf/FubonSsi/FubonSsiPendingInfo.vue';
...
export default class FubonPaymentInstitution extends Vue {
  /**
   * data
   */
