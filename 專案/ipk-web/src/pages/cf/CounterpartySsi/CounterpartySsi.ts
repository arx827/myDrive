...
import CounterpartySsiDataInfo from '@/pages/cf/CounterpartySsi/CounterpartySsiDataInfo.vue';
import CounterpartySsiPendingInfo from '@/pages/cf/CounterpartySsi/CounterpartySsiPendingInfo.vue';
...
export default class CounterpartyPaymentInstitution extends Vue {
