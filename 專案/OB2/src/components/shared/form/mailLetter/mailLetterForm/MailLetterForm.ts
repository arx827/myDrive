...
export default class MailLetterForm extends Vue {
    ...
    created() {
        ...
        // console.log(PackMatchModule.matchedCasePack.packNo);
        //上方郵寄設定table讀取
 ...
 */
    ...
    onSaveMailByPostSettingSubmit() {
        ...
        for (var i = 0; i < gridList.length; i++) {
            ...
            if (grid.autoLetter == "N") {
                ...
                if (grid.noLetterReasonCode == null || grid.noLetterContent == "") {
    ...
    onSelectOptionsChange(e) {
        let mailByPostSetting: CasesTaskMailGrid = {};
        mailByPostSetting = e.row.data;
        mailByPostSetting.noLetterReasonCode = e.$event;
    ...
    //inputChange改變時
    onSelectionInputChange(e) {
        let mailByPostSetting: CasesTaskMailGrid = {};
        mailByPostSetting = JSON.parse(JSON.stringify(e.data));
    }
