import { ComponentDto, CaseCallUpHistoryDto, CaseCallUpHistoryInput, INumDto, PageOfCaseCallUpHistoryDto, ServiceHistorygDto, CallRecordDto } from "@fubonlife/obd-api-axios-sdk";
