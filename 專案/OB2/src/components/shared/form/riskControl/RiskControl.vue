    ...
    <a-collapse v-model="activeKey" class="modal-collapse">
      ...
      >
        ...
        >
          ...
          >
            <!-- 開啟清單 -->
            <a v-if="shouldPayNoPayInfoFlag" @click="shouldPayNoPayInfoShow = true">{{
              $t("riskControl_openList")
            }}</a>
            <span v-else class="noDataList">
              {{$t("riskControl_openList")}}
      ...
      >
        ...
        >
          ...
          >
            <!-- 開啟清單 -->
            <a v-if="applicantDesignatedRemittanceAccountData.data.length>0" @click="applicantDesignatedRemittanceAccountShow = true">{{
              $t("riskControl_openList")
            }}</a>
            <span v-else class="noDataList">
              {{$t("riskControl_openList")}}
          ...
          >
            <!-- 開啟清單 -->
            <a v-if="listOfBeneficiariesAfterChangeData.data.length>0" @click="listOfBeneficiariesAfterChangeShow = true">{{
              $t("riskControl_openList")
            }}</a>
            <span v-else class="noDataList">
              {{$t("riskControl_openList")}}
          ...
          >
            <!-- 開啟清單 -->
            <a v-if="paymentInformationPaymentChecklistFlag" @click="paymentInformationPaymentChecklistShow = true">{{
              $t("riskControl_openList")
            }}</a>
            <span v-else class="noDataList">
              {{$t("riskControl_openList")}}
    ...
    >
      <template v-slot:title>
        <div class="modal-descriptions-telList" >
          ...
          <!-- 電話清單 -->
          <a v-if="telListData.data.length>0" @click="telListShow = true">{{ $t("riskControl_telList") }}</a>
