...
import Basic from "./SuspectiveBasic.vue";
import ReviewWork from "./SuspectiveReview.vue"
import SuspectiveInfo from "./SuspectiveInfo.vue";
import CaseSearchPage from "@/pages/case/CaseSearchPage.vue";

@Component({
    components: {  DragModal, Basic, ReviewWork, SuspectiveInfo, CaseSearchPage }
  })
  export default class SuspectiveModal extends Vue {
    @Prop()
    step: number;
