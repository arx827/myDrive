<template >
  <div tabindex="-1" @keyup.enter="infSearch">
        ...
        >
          ...
          >
            ...
            <a-col :xs="24" :md="12" :xl="8" :xxl="5">
              ...
              >
                ...
                >
                  <a-input type="text" v-model="infSearchForm.custId"></a-input>
                </a-popover>
              </a-form-model-item>
            </a-col>
            <a-col :xs="24" :md="12" :xl="8" :xxl="5">
            ...
            <a-col
              ...
              :xl="8"
              :xxl="1"
              style="width: 20px; padding-top: 10px"
            >
              ~
            </a-col>
            ...
            <a-col :xs="24" :md="12" :xl="8" :xxl="6">
              <a-form-model-item>
                <span slot="label"> {{ $t("handledStatus") }} </span>
                <a-select
                  class="select"
                  mode="multiple"
            ...
            <a-col :xs="24" :md="12" :xl="8" :xxl="4">
              <a-row>
                <a-form-model-item
                  class="dateStart"
                  :label="$t('infReplay_date')"
                  style="margin-bottom: 0px"
                  :has-feedback="infSearchValidateForm.replyDateStart.feedback"
                  :validateStatus="infSearchValidateForm.replyDateStart.state"
                >
                  <a-popover
                    placement="top"
                    :content="infSearchValidateForm.replyDateStart.msg"
                    :trigger="infSearchValidateForm.replyDateStart.hover"
                    :visible="isReplyDateStartVisible"
                    :destroyTooltipOnHide="true"
                  >
                    <DatePicker
                      :formatter="formatter"
                      @change="onReplyDateStartChange"
                      v-model="infSearchForm.replyStartDate"
                    ...
                    >
                      <a-input
                        ...
                        :value="infSearchForm.replyStartDateString"
                        @mouseover="eventMouseOverReplyDateStart"
                        @mouseleave="isReplyDateStartVisible = false"
                      ></a-input>
                      <i
                        v-if="infSearchValidateForm.replyDateStart.feedback"
                        slot="icon-calendar"
                      ></i>
                    </DatePicker>
                  </a-popover>
            ...
            <a-col :xs="24" :md="12" :xl="8" :xxl="1" style="width:20px; padding-top: 10px"> ~ </a-col>
              ...
              <a-form-model-item
                ...
                label=""
                style="margin-bottom: 0px"
                :has-feedback="infSearchValidateForm.replyDateEnd.feedback"
                :validateStatus="infSearchValidateForm.replyDateEnd.state"
              >
                <a-popover
                  placement="top"
                  :content="infSearchValidateForm.replyDateEnd.msg"
                  :trigger="infSearchValidateForm.replyDateEnd.hover"
                  :visible="isExpiryEndVisible"
                  :destroyTooltipOnHide="true"
                >
                  <DatePicker
                    :formatter="formatter"
                    @change="onReplyDateEndChange"
                    v-model="infSearchForm.replyEndDate"
                  ...
                  >
                    <a-input
                      slot="input"
                      @pressEnter="checkManualInputReplytEndDate"
                      :value="infSearchForm.replyEndDateString"
                      @mouseover="eventMouseOverReplyDateEnd"
                      @mouseleave="isReplyDateEndVisible = false"
                    ></a-input>
                    <i
                      v-if="infSearchValidateForm.replyDateEnd.feedback"
                      slot="icon-calendar"
                    ></i>
                  </DatePicker>
                </a-popover>
          ...
          <div>
            <a-row type="flex" justify="center" class="searchBar">
              <!-- 查詢 -->
              <a-button type="primary" @click="isIncludeAgent = false;onClickSearchButton()">{{
                $t("global_search")
              }}</a-button>
              <!-- 清除 -->
              <a-button type="default" @click="infSearchReset">{{
                $t("global_clean")
              }}</a-button>
            </a-row>
          </div>
    ...
    <a-row class="dataNumBar">
      <!-- 作業單 X 筆 -->
      {{ $t("infPage_infInfoCount") }}：{{ this.grid.pagination.total }}
      {{ $t("pedding_count") }} <br />
    </a-row>
    <div class="fbl-table">
      <FblDataGrid
        ...
        @inspectClick="handleInspectClick($event)"
...
<script src="./CountersignatureClosePage.ts" lang="ts"></script>
