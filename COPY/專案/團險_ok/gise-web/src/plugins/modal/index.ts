...
import { ExclamationCircleFilled, CheckCircleFilled, CloseCircleFilled } from '@ant-design/icons-vue'
...
export class ModalService {
  ...
  public info(option?: ModalFuncProps) {
    Modal.info(this.config({ icon: createVNode(ExclamationCircleFilled), ...option }))
  }

  public success(option?: ModalFuncProps) {
    Modal.success(this.config({ icon: createVNode(CheckCircleFilled), ...option }))
  }

  public error(option?: ModalFuncProps) {
    Modal.error(this.config({ icon: createVNode(CloseCircleFilled), ...option }))
  }

  public warning(option?: ModalFuncProps) {
    Modal.warning(this.config({ icon: createVNode(ExclamationCircleFilled), ...option }))
  }

  public confirm(option?: ModalFuncProps) {
    Modal.confirm(this.config({ icon: createVNode(ExclamationCircleFilled), ...option }))
  }
