...
import InfoModal from '@/plugins/backStagePlugins/notification/infoModal';
import InfoNotification from '@/plugins/backStagePlugins/notification/infoNotification';
...
export default class ParamMaintainList extends Vue {
	...
	// 	this.setLoading(true);
		...
		this.gridData.data = TESTDATA.content;
