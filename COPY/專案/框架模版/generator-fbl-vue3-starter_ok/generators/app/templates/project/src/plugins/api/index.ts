...
import type { Configuration, AuthApi } from '@fubonlife/<%= code %>-api-axios-sdk'
import { AuthApiFactory } from '@fubonlife/<%= code %>-api-axios-sdk'
...
export class Api {
  public install(app: App, options?: Configuration) {
    ...
    $appGlobal.$authApi = AuthApiFactory(options, import.meta.env.VITE_APP_BASE_URL, axios)
  }
}
