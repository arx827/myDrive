...
import BackModal from '@/pages/OccupationalSafety/OtherOptions/RoleMaintain/BackModal.vue';
import { Action } from 'vuex-class';
import moment from 'moment';
import { CertPassUpdateDto } from '@fubonlife/oss-api-axios-sdk';

@Component({ components: { BackModal } })
export default class ViewNurseRecordModal extends Vue {
  ...
  async fetchUpdateReviewStatus(isAgree, certPassUpdateUserDtoList) {
  	const $form: CertPassUpdateDto = {	isAgree,	certPassUpdateUserDtoList };
  	this.setLoading(true);
