...
export default class DragModal extends Vue {
  ...
  handleMove(event) {
    ...
    // console.log('locatX:' + locatX, 'locatY:' + locatY)
    this.modalContent.style.transform = `translate(${locatX}px, ${locatY}px)`;
  }
