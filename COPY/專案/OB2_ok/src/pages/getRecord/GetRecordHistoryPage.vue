        ...
        >
          <a-row type="flex" :gutter="[{ xs: 10, xxl: 10 }, 0]">
            ...
            <a-col :xs="24" :md="12" :xl="8" :xxl="8">
              ...
              >
                <span slot="label">{{
                  $t("getRecordHistoryPage_createId")
                }}</span>
                <a-popover
                  placement="top"
                  :content="
          ...
          <div>
            ...
            >
              <!-- 查詢 -->
              <a-button
                v-if="authComponent.COM_RECORD_HISTORY_SEARCH.show"
                :disabled="!authComponent.COM_RECORD_HISTORY_SEARCH.enable"
                type="primary"
              ...
              >
              <a-divider
                v-if="authComponent.COM_RECORD_HISTORY_EXPORT.show"
                type="vertical"
              ></a-divider>
              <!-- 查詢結果匯出 -->
              <a-button
                v-if="authComponent.COM_RECORD_HISTORY_EXPORT.show"
                :disabled="!authComponent.COM_RECORD_HISTORY_EXPORT.enable"
                class="ml-auto"
                type="primary"
...
<script src="./GetRecordHistoryPage.ts" lang="ts"></script>
