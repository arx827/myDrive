  ...
  <div tabindex="-1" @keyup.enter="searchCasePage">
                ...
                <a-row>
                  <a-form-model-item>
                    ...
                    <a-row type="flex" class="datePicker__interval">
                      <a-form-model-item
                        prop="closeStartDate"
                        :has-feedback="casePageSearchValidateForm.closeStartDate.feedback"
                        :validateStatus="casePageSearchValidateForm.closeStartDate.state"
                      >
                        <a-popover
                          placement="top"
                          :content="casePageSearchValidateForm.closeStartDate.msg"
                          :trigger="casePageSearchValidateForm.closeStartDate.hover"
                        ...
                        >
                          <DatePicker
                            ...
                            v-model="casePageSearchForm.closeStartDate"
                          ...
                          >
                            ...
                            <a-input
                              ...
                              :value="casePageSearchForm.closeStartString"
                      ...
                      <a-form-model-item
                        prop="closeEndDate"
                        :has-feedback="casePageSearchValidateForm.closeEndDate.feedback"
                        :validateStatus="casePageSearchValidateForm.closeEndDate.state"
                      >
                        <a-popover
                          placement="top"
                          :content="casePageSearchValidateForm.closeEndDate.msg"
                          :trigger="casePageSearchValidateForm.closeEndDate.hover"
                        ...
                        >
                          <DatePicker
                            ...
                            v-model="casePageSearchForm.closeEndDate"
                          ...
                          >
                            ...
                            <a-input
                              ...
                              :value="casePageSearchForm.closeEndString"
    ...
    <div class="fbl-table">
      ...
      >
        ...
        <template v-slot:questNameTemp="slotProps">
          <a v-if="slotProps.data.questName==null" @click="questPreview(slotProps.data.packNo,slotProps.data.caseNo)">
            {{$t('case_result_grid_quest_preview')}}
          </a>
          <a v-else-if="slotProps.data.questName==''" @click="questPreview(slotProps.data.packNo,slotProps.data.caseNo)">
            {{$t('case_result_grid_quest_preview')}}
          </a>
          <a v-else  @click="questPreview(slotProps.data.packNo,slotProps.data.caseNo)">
            {{slotProps.data.questName}}
          </a>
        </template>
    ...
    <a-modal
        ...
        :visible="caseSearchPageGridModal.idShowQuestPreviewModal"
        :title="$t('case_result_grid_quest_preview')"
        :closable="true"
        :destroyOnClose="true"
        :keyboard="true"
        :mask="false"
        width="1400px"
        @cancel="onCloseModal('idShowQuestPreviewModal')"

    >
    <!--自訂按鈕區-->
    <template #footer>
        <a-button key="OK" @click="onCloseModal('idShowQuestPreviewModal')">關閉</a-button>
    </template>
      ...
      <div class="questDiv" id="questDiv"> <!--因為題目區域的questanswer是包在questarea裡所以題目區域的按鈕與開場白、核身不同-->
        <!-- 問卷「題目」顯示區塊 -->
        <div v-if="true" class="sectionRight-block">
          <BlockHeader
            ref="headerQuest"
