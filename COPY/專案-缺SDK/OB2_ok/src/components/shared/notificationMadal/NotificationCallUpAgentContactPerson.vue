      ...
      >
        <a-row type="flex">
          <a-col flex="5">
            ...
            <span v-if="isNotContact" style="color: red">{{
              $t(
                "notificationCallUpAgentContactPerson_whetherSendToAgentConfirm"
              )
            }}</span>
          </a-col>
        </a-row>
          ...
          >
            ...
            <template v-slot:extensionTemp="slotProps">
              <div v-if="slotProps.data.isProp || slotProps.data.isDataAdd">
                <a-input
                  :disabled="
                    slotProps.data.isExtCallup ||
                    !(slotProps.data.isCallup ^ slotProps.data.isResult)
                  "
            ...
            <template v-slot:callUpResultTemp="slotProps">
              <div v-if="slotProps.data.isProp || slotProps.data.isDataAdd">
                <a-select
                  ...
                  @change="
                    onUpdateCallUpData(slotProps.data);
                    onCallUpResultChange(slotProps.data);
                  "
                ></a-select>
              </div>
            </template>
            ...
            <template v-slot:contactDetailTemp="slotProps">
              <div v-if="slotProps.data.isProp || slotProps.data.isDataAdd">
                <a-select
                  ...
                  @change="onUpdateCallUpData(slotProps.data)"
                ></a-select>
              </div>
            </template>
            <!-- 通話內容 -->
