	...
	public alertError(option: OptionModal) {
  	...
  	if (option.confirm) {
  		this.currentModal = Modal.confirm({
  			...
  			class: `${option.class} modal__custom__confirm` || 'modal__custom__confirm',
  		...
  		Modal.error({
  			...
  			class: `${option.class} alert-modal modal__custom__confirm with__single__btn` || 'alert-modal modal__custom__confirm with__single__btn',
  			icon,
  			onOk: option.onCallback,
  			okButtonProps: {
  				props: {
